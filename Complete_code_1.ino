...
const int buttonPin[NButtons] = {10, 11, 12, 13, 6, 7, 8, 9, 2, 3, 4, 5};     //* the number of the pushbutton pin
...
const int NPots = 2; //* The number of potentiometers
...
// uncoment the section below if you are using the pin with a built in led
//    if(i == 3) { // choose the index of the pin with the built in led
...
void potentiometers() {
    ...
    if (potMoving == true) { // If the potentiometer is still moving, send the change control
      //if (midiPState[i] != midiCState[i]) { //(un)uncheck this your readinf is(n't) slow
